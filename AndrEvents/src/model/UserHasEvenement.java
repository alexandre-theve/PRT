...
public class UserHasEvenement implements Serializable {
	...
	public boolean equals(Object object) {
		...
		if ((this.userHasEvenementPK == null && other.userHasEvenementPK != null)
				|| (this.userHasEvenementPK != null && !this.userHasEvenementPK
						.equals(other.userHasEvenementPK))) {
			return false;
		}
		return true;
	}
	...
	public String toString() {
		return "andrevent.server.model.UserHasEvenement[ userHasEvenementPK="
				+ userHasEvenementPK + " ]";
	}
}
